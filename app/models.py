from sqlalchemy import Column, String, Boolean, Integer, Float, Date, ForeignKey, Text, JSON
...
class Employee(Base):
    ...
    requires_bank_card_sales = Column(Boolean, default=False)
    requires_cash_tips = Column(Boolean, default=False)
    requires_total_sales = Column(Boolean, default=False)
